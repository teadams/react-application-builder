...
function Body(props) {
  const {selected_menu, object_type="",  field_name="", menu_type, open, onClose} = props
  let {id=""} = props
  ...
  return (< BodyComponent object_type={object_type} id={id} field_name={field_name} open={open} onClose={onClose} {...rest}  />)  
}
