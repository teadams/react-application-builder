  ...
  return (
    ...
    <div style={{display:'flex',padding:10, width:"99%", alignSelf:"center", justifyContent:"center"}}>
      <div style={{width:"50%", paddingRight:10,xborder:"5px solid  blue"}}>
        ...
        field_click_to_edit = {false} num_columns={1} action_props={{layout:"nwn_project_create_form"}} field_list={["summary", "leader", "core_address_city", "core_address_state", "core_address_country", "description","type"]}/>
      </div>
