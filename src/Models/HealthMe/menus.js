const metadata_menus = {
  app_menu: [
    ...
    {index:"3", label: "Hierarchy", object_type: "core_subsite_hierarchy", component:"ObjectList", order_by:"ancestor_subsite,leaf_subsite", order_by_direction:"asc,asc", grouping_field:"leaf_subsite", display_value:"leaf_subsite"}
 ],
  hamburger: [
