...
const metadata_fields = {
  ...
  nwn_project_post: [
    ...
    {name:"core_role", section:"basic", pretty_name: "Role Type", references:"core_role", index:true},
  ...
  nwn_project_need: [
    {name:"id",  section:"basic",  pretty_name: "Id", data_type: "integer", required:true, key:true},
    {name:"role_name", section:"basic", pretty_name: "Role Type", references:"core_role", index:true, pretty_key:"true"},
    {name:"nwn_project", section:"basic", pretty_name: "Project", references:"nwn_project", index:true}, 
    {name:"description",  section:"basic",  pretty_name: "Description", data_type: "string"},
  ...
  nwn_project_volunteer: [
    ...
    {name:"nwn_project", section:"basic", pretty_name: "Project", references:"nwn_project", index:true}, 
    {name:"core_role", section:"basic",grid_col:6, pretty_name: "Role Type", references:"core_role", data_type: "string"},
