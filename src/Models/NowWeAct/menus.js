const metadata_menus = {
  app_menu: [
    {index:"0", label: "Volunteer",  object_type:"nwn_project", component:"Volunteer", project_id:2},
    {index:"6", label: "Map", object_type: "nwn_project", component:"GoogleMap", title:"Projects Across the World", text:"Click on a pin to learn more about a project", object_type:"nwn_project"},
