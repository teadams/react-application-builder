...
function FieldView(props)  {
  const {object_type, field_name, data, display, ...params} = props
  ...
  const RenderField = functional_components[field_comp_component]
    ...
    return <RenderField {...params} object_type={object_type} field_name={field_name} data={data} display={display}/>
