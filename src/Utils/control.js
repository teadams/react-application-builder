...
import {ACSDrillDown, ACSWizard, ACSTabMenu, ACSComboField, ACSField, ACSTextField, ACSFile, ACSImage, ACSDate, ACSWysiwygEditor, ACSReferencesList, ACSMapping, ACSReferenceMapping, ACSMappingOrdering} from '../ACSLibrary/index.js'
...
function componentPicker(name, source="not provided") {
  ...
  switch (name) {
    ...
    case "ACSMappingOrdering":  return ACSMappingOrdering;
