    ...
    return (<Tag Tag={combo_wrap_tag} style={combo_wrap_tag_style}>
        {combo_fields.map((field_name,index) => {
          ...
          <Tag Tag={combo_field_wraps[index]?combo_field_wraps[index]:"div"}  style={combo_field_wrap_styles[index]}>
              <Fragment>
              {(mode === "view")?  
              <ACSFieldController  rab_component_model={rab_component_model} object_type={object_type} id={id} mode={mode}  data={data} field_name={field_name} {...combo_field_wrap_props[index]}/>
              :
              <ACSFieldController rab_component_model={rab_component_model} handleFormChange={handleFormChange} handleFormSubmit={handleFormSubmit} formValues={formValues}  field_models={field_models}   object_type={object_type} id={id} mode={mode}  form={form} data={data} field_name={field_name} {...combo_field_wrap_props[index]}/>
              }
              </Fragment>
          </Tag>)
        })}
