              ...
              if (index === current_step_number) {return null}
               ...
               return (
                <Fragment>
                  ...
                  {description && <div style={step_description_style}> {description}</div>}
                  <p/>
                  <WizardComponent row_autoFocus={false} onSubmit={handleStepSubmit} data={data} object_type={object_type} id={id} onClose={handleFormClose} row_delayed_auth={true} row_form={true} no_header={true} row_dialog_center={true} mode={mode}  delay_dirty={true} {...wizard_props}/>
                </Fragment>
               )
             })}
          </Fragment>
